...
const VersionList = ({ page, onActionComplete }) => {
    ...
    const handleDeleteVersion = async (versionId) => {
        ...
        try {
            const response = await fetch(`/api/pages/${slug}/versions/${versionId}`, { method: 'DELETE' });
    ...
    const handlePublishVersion = async (versionId) => {
        ...
        try {
            const response = await fetch(`/api/pages/${slug}/versions/${versionId}/publish`, { method: 'PUT' });
